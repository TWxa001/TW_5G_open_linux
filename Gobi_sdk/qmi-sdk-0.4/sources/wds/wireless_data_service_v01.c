...
GENERAL DESCRIPTION
 ...
 QUALCOMM Proprietary and Confidential.
  ...
  $Header: //source/qcom/qct/interfaces/qmi/wds/main/latest/src/wireless_data_service_v01.c#20 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 5.3 
   ...
   It was generated on: Wed May 23 2012
...
static const uint8_t wds_set_event_report_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wds_set_event_report_req_msg_v01, report_uplink_flow_control) - QMI_IDL_OFFSET8(wds_set_event_report_req_msg_v01, report_uplink_flow_control_valid)),
  0x1B,
  QMI_IDL_GENERIC_1_BYTE,
...
static const uint8_t wds_event_report_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wds_event_report_ind_msg_v01, uplink_flow_control) - QMI_IDL_OFFSET16RELATIVE(wds_event_report_ind_msg_v01, uplink_flow_control_valid)),
  0x27,
...
static const uint8_t wds_indication_register_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wds_indication_register_req_msg_v01, report_embms_tmgi_list) - QMI_IDL_OFFSET8(wds_indication_register_req_msg_v01, report_embms_tmgi_list_valid)),
  0x10,
  QMI_IDL_GENERIC_1_BYTE,
...
static const uint8_t wds_create_profile_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wds_create_profile_req_msg_v01, pdn_label) - QMI_IDL_OFFSET16RELATIVE(wds_create_profile_req_msg_v01, pdn_label_valid)),
  0xB0,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
...
static const uint8_t wds_modify_profile_settings_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wds_modify_profile_settings_req_msg_v01, pdn_label) - QMI_IDL_OFFSET16RELATIVE(wds_modify_profile_settings_req_msg_v01, pdn_label_valid)),
  0xB0,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |   QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_STRING,
...
static const uint8_t wds_get_runtime_settings_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wds_get_runtime_settings_resp_msg_v01, pcscf_ipv6_server_addr_list) - QMI_IDL_OFFSET16RELATIVE(wds_get_runtime_settings_resp_msg_v01, pcscf_ipv6_server_addr_list_valid)),
  0x2E,
  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
...
static const uint8_t wds_embms_tmgi_list_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(wds_embms_tmgi_list_ind_msg_v01, warn_reason) - QMI_IDL_OFFSET16RELATIVE(wds_embms_tmgi_list_ind_msg_v01, warn_reason_valid)),
  0x11,
  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_4_BYTE,
...
static const uint8_t wds_get_last_data_call_status_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(wds_get_last_data_call_status_resp_msg_v01, data_call_type) - QMI_IDL_OFFSET8(wds_get_last_data_call_status_resp_msg_v01, data_call_type_valid)),
  0x11,
  QMI_IDL_AGGREGATE,
...
static const qmi_idl_service_message_table_entry wds_service_command_messages_v01[] = {
  ...
  {QMI_WDS_SET_EVENT_REPORT_REQ_V01, TYPE16(0, 2), 48},
  {QMI_WDS_ABORT_REQ_V01, TYPE16(0, 5), 5},
  {QMI_WDS_INDICATION_REGISTER_REQ_V01, TYPE16(0, 7), 4},
  {QMI_WDS_START_NETWORK_INTERFACE_REQ_V01, TYPE16(0, 9), 481},
  {QMI_WDS_STOP_NETWORK_INTERFACE_REQ_V01, TYPE16(0, 11), 11},
  {QMI_WDS_GET_PKT_SRVC_STATUS_REQ_V01, TYPE16(0, 13), 0},
  {QMI_WDS_GET_CURRENT_CHANNEL_RATE_REQ_V01, TYPE16(0, 16), 0},
  {QMI_WDS_GET_PKT_STATISTICS_REQ_V01, TYPE16(0, 18), 7},
  {QMI_WDS_GO_DORMANT_REQ_V01, TYPE16(0, 20), 0},
  {QMI_WDS_GO_ACTIVE_REQ_V01, TYPE16(0, 22), 0},
  {QMI_WDS_CREATE_PROFILE_REQ_V01, TYPE16(0, 24), 1903},
  {QMI_WDS_MODIFY_PROFILE_SETTINGS_REQ_V01, TYPE16(0, 26), 1900},
  {QMI_WDS_DELETE_PROFILE_REQ_V01, TYPE16(0, 28), 5},
  {QMI_WDS_GET_PROFILE_LIST_REQ_V01, TYPE16(0, 30), 4},
  {QMI_WDS_GET_PROFILE_SETTINGS_REQ_V01, TYPE16(0, 32), 5},
  {QMI_WDS_GET_DEFAULT_SETTINGS_REQ_V01, TYPE16(0, 34), 4},
  {QMI_WDS_GET_RUNTIME_SETTINGS_REQ_V01, TYPE16(0, 36), 7},
  {QMI_WDS_SET_MIP_MODE_REQ_V01, TYPE16(0, 38), 4},
  {QMI_WDS_GET_MIP_MODE_REQ_V01, TYPE16(0, 40), 0},
  {QMI_WDS_GET_DORMANCY_STATUS_REQ_V01, TYPE16(0, 42), 0},
  {QMI_WDS_GET_AUTOCONNECT_SETTING_REQ_V01, TYPE16(0, 44), 0},
  {QMI_WDS_GET_CALL_DURATION_REQ_V01, TYPE16(0, 46), 0},
  {QMI_WDS_GET_DATA_BEARER_TECHNOLOGY_REQ_V01, TYPE16(0, 48), 0},
  {QMI_WDS_GET_DUN_CALL_INFO_REQ_V01, TYPE16(0, 50), 31},
  {QMI_WDS_GET_ACTIVE_MIP_PROFILE_REQ_V01, TYPE16(0, 53), 0},
  {QMI_WDS_SET_ACTIVE_MIP_PROFILE_REQ_V01, TYPE16(0, 55), 10},
  {QMI_WDS_READ_MIP_PROFILE_REQ_V01, TYPE16(0, 57), 4},
  {QMI_WDS_MODIFY_MIP_PROFILE_REQ_V01, TYPE16(0, 59), 166},
  {QMI_WDS_GET_MIP_SETTINGS_REQ_V01, TYPE16(0, 61), 0},
  {QMI_WDS_SET_MIP_SETTINGS_REQ_V01, TYPE16(0, 63), 37},
  {QMI_WDS_GET_LAST_MIP_STATUS_REQ_V01, TYPE16(0, 65), 0},
  {QMI_WDS_GET_CURRENT_DATA_BEARER_TECHNOLOGY_REQ_V01, TYPE16(0, 67), 0},
  {QMI_WDS_CALL_HISTORY_LIST_REQ_V01, TYPE16(0, 69), 0},
  {QMI_WDS_CALL_HISTORY_READ_REQ_V01, TYPE16(0, 71), 5},
  {QMI_WDS_CALL_HISTORY_DELETE_REQ_V01, TYPE16(0, 73), 0},
  {QMI_WDS_CALL_HISTORY_MAX_SIZE_REQ_V01, TYPE16(0, 75), 0},
  {QMI_WDS_GET_DEFAULT_PROFILE_NUM_REQ_V01, TYPE16(0, 77), 5},
  {QMI_WDS_SET_DEFAULT_PROFILE_NUM_REQ_V01, TYPE16(0, 79), 6},
  {QMI_WDS_RESET_PROFILE_TO_DEFAULT_REQ_V01, TYPE16(0, 81), 5},
  {QMI_WDS_RESET_PROFILE_PARAM_TO_INVALID_REQ_V01, TYPE16(0, 83), 9},
  {QMI_WDS_SET_CLIENT_IP_FAMILY_PREF_REQ_V01, TYPE16(0, 85), 4},
  {QMI_WDS_FMC_SET_TUNNEL_PARAMS_REQ_V01, TYPE16(0, 87), 36},
  {QMI_WDS_FMC_CLEAR_TUNNEL_PARAMS_REQ_V01, TYPE16(0, 89), 0},
  {QMI_WDS_FMC_GET_TUNNEL_PARAMS_REQ_V01, TYPE16(0, 91), 0},
  {QMI_WDS_SET_AUTOCONNECT_SETTINGS_REQ_V01, TYPE16(0, 93), 8},
  {QMI_WDS_GET_DNS_SETTINGS_REQ_V01, TYPE16(0, 95), 0},
  {QMI_WDS_SET_DNS_SETTINGS_REQ_V01, TYPE16(0, 97), 52},
  {QMI_WDS_GET_PRE_DORMANCY_CDMA_SETTINGS_REQ_V01, TYPE16(0, 99), 0},
  {QMI_WDS_SET_CAM_TIMER_REQ_V01, TYPE16(0, 101), 7},
  {QMI_WDS_GET_CAM_TIMER_REQ_V01, TYPE16(0, 103), 0},
  {QMI_WDS_SET_SCRM_REQ_V01, TYPE16(0, 105), 4},
  {QMI_WDS_GET_SCRM_REQ_V01, TYPE16(0, 107), 0},
  {QMI_WDS_SET_RDUD_REQ_V01, TYPE16(0, 109), 4},
  {QMI_WDS_GET_RDUD_REQ_V01, TYPE16(0, 111), 0},
  {QMI_WDS_GET_SIP_MIP_CALL_TYPE_REQ_V01, TYPE16(0, 113), 0},
  {QMI_WDS_SET_EVDO_PAGE_MONITOR_PERIOD_REQ_V01, TYPE16(0, 115), 4},
  {QMI_WDS_SET_EVDO_FORCE_LONG_SLEEP_REQ_V01, TYPE16(0, 118), 4},
  {QMI_WDS_GET_EVDO_PAGE_MONITOR_PERIOD_REQ_V01, TYPE16(0, 120), 0},
  {QMI_WDS_GET_CALL_THROTTLE_INFO_REQ_V01, TYPE16(0, 122), 0},
  {QMI_WDS_GET_NSAPI_REQ_V01, TYPE16(0, 124), 153},
  {QMI_WDS_SET_DUN_CTRL_PREF_REQ_V01, TYPE16(0, 126), 8},
  {QMI_WDS_GET_DUN_CTRL_INFO_REQ_V01, TYPE16(0, 128), 0},
  {QMI_WDS_SET_DUN_CTRL_EVENT_REPORT_REQ_V01, TYPE16(0, 130), 12},
  {QMI_WDS_CONTROL_PENDING_DUN_CALL_REQ_V01, TYPE16(0, 133), 8},
  {QMI_WDS_EMBMS_TMGI_ACTIVATE_REQ_V01, TYPE16(0, 135), 11},
  {QMI_WDS_EMBMS_TMGI_DEACTIVATE_REQ_V01, TYPE16(0, 138), 11},
  {QMI_WDS_EMBMS_TMGI_LIST_QUERY_REQ_V01, TYPE16(0, 141), 4},
  {QMI_WDS_GET_PREFERRED_DATA_SYSTEM_REQ_V01, TYPE16(0, 144), 0},
  {QMI_WDS_GET_LAST_DATA_CALL_STATUS_REQ_V01, TYPE16(0, 146), 0},
  {QMI_WDS_GET_CURRENT_SYSTEM_STATUS_REQ_V01, TYPE16(0, 148), 0},
  {QMI_WDS_GET_PDN_THROTTLE_INFO_REQ_V01, TYPE16(0, 150), 4},
  {QMI_WDS_GET_LTE_ATTACH_PARAMS_REQ_V01, TYPE16(0, 152), 0},
  {QMI_WDS_RESET_PKT_STATISTICS_REQ_V01, TYPE16(0, 154), 0},
  {QMI_WDS_GET_FLOW_CONTROL_STATUS_REQ_V01, TYPE16(0, 156), 0}
};
...
static const qmi_idl_service_message_table_entry wds_service_response_messages_v01[] = {
  ...
  {QMI_WDS_INDICATION_REGISTER_RESP_V01, TYPE16(0, 8), 7},
  {QMI_WDS_START_NETWORK_INTERFACE_RESP_V01, TYPE16(0, 10), 26},
  {QMI_WDS_STOP_NETWORK_INTERFACE_RESP_V01, TYPE16(0, 12), 7},
  {QMI_WDS_GET_PKT_SRVC_STATUS_RESP_V01, TYPE16(0, 14), 11},
  {QMI_WDS_GET_CURRENT_CHANNEL_RATE_RESP_V01, TYPE16(0, 17), 26},
  {QMI_WDS_GET_PKT_STATISTICS_RESP_V01, TYPE16(0, 19), 107},
  {QMI_WDS_GO_DORMANT_RESP_V01, TYPE16(0, 21), 7},
  {QMI_WDS_GO_ACTIVE_RESP_V01, TYPE16(0, 23), 7},
  {QMI_WDS_CREATE_PROFILE_RESP_V01, TYPE16(0, 25), 17},
  {QMI_WDS_MODIFY_PROFILE_SETTINGS_RESP_V01, TYPE16(0, 27), 12},
  {QMI_WDS_DELETE_PROFILE_RESP_V01, TYPE16(0, 29), 12},
  {QMI_WDS_GET_PROFILE_LIST_RESP_V01, TYPE16(0, 31), 13531},
  {QMI_WDS_GET_PROFILE_SETTINGS_RESP_V01, TYPE16(0, 33), 1907},
  {QMI_WDS_GET_DEFAULT_SETTINGS_RESP_V01, TYPE16(0, 35), 1907},
  {QMI_WDS_GET_RUNTIME_SETTINGS_RESP_V01, TYPE16(0, 37), 8708},
  {QMI_WDS_SET_MIP_MODE_RESP_V01, TYPE16(0, 39), 7},
  {QMI_WDS_GET_MIP_MODE_RESP_V01, TYPE16(0, 41), 11},
  {QMI_WDS_GET_DORMANCY_STATUS_RESP_V01, TYPE16(0, 43), 11},
  {QMI_WDS_GET_AUTOCONNECT_SETTING_RESP_V01, TYPE16(0, 45), 15},
  {QMI_WDS_GET_CALL_DURATION_RESP_V01, TYPE16(0, 47), 51},
  {QMI_WDS_GET_DATA_BEARER_TECHNOLOGY_RESP_V01, TYPE16(0, 49), 15},
  {QMI_WDS_GET_DUN_CALL_INFO_RESP_V01, TYPE16(0, 51), 110},
  {QMI_WDS_GET_ACTIVE_MIP_PROFILE_RESP_V01, TYPE16(0, 54), 11},
  {QMI_WDS_SET_ACTIVE_MIP_PROFILE_RESP_V01, TYPE16(0, 56), 7},
  {QMI_WDS_READ_MIP_PROFILE_RESP_V01, TYPE16(0, 58), 133},
  {QMI_WDS_MODIFY_MIP_PROFILE_RESP_V01, TYPE16(0, 60), 7},
  {QMI_WDS_GET_MIP_SETTINGS_RESP_V01, TYPE16(0, 62), 35},
  {QMI_WDS_SET_MIP_SETTINGS_RESP_V01, TYPE16(0, 64), 7},
  {QMI_WDS_GET_LAST_MIP_STATUS_RESP_V01, TYPE16(0, 66), 11},
  {QMI_WDS_GET_CURRENT_DATA_BEARER_TECHNOLOGY_RESP_V01, TYPE16(0, 68), 31},
  {QMI_WDS_CALL_HISTORY_LIST_RESP_V01, TYPE16(0, 70), 7667},
  {QMI_WDS_CALL_HISTORY_READ_RESP_V01, TYPE16(0, 72), 159},
  {QMI_WDS_CALL_HISTORY_DELETE_RESP_V01, TYPE16(0, 74), 7},
  {QMI_WDS_CALL_HISTORY_MAX_SIZE_RESP_V01, TYPE16(0, 76), 12},
  {QMI_WDS_GET_DEFAULT_PROFILE_NUM_RESP_V01, TYPE16(0, 78), 16},
  {QMI_WDS_SET_DEFAULT_PROFILE_NUM_RESP_V01, TYPE16(0, 80), 12},
  {QMI_WDS_RESET_PROFILE_TO_DEFAULT_RESP_V01, TYPE16(0, 82), 12},
  {QMI_WDS_RESET_PROFILE_PARAM_TO_INVALID_RESP_V01, TYPE16(0, 84), 12},
  {QMI_WDS_SET_CLIENT_IP_FAMILY_PREF_RESP_V01, TYPE16(0, 86), 7},
  {QMI_WDS_FMC_SET_TUNNEL_PARAMS_RESP_V01, TYPE16(0, 88), 7},
  {QMI_WDS_FMC_CLEAR_TUNNEL_PARAMS_RESP_V01, TYPE16(0, 90), 7},
  {QMI_WDS_FMC_GET_TUNNEL_PARAMS_RESP_V01, TYPE16(0, 92), 43},
  {QMI_WDS_SET_AUTOCONNECT_SETTINGS_RESP_V01, TYPE16(0, 94), 7},
  {QMI_WDS_GET_DNS_SETTINGS_RESP_V01, TYPE16(0, 96), 59},
  {QMI_WDS_SET_DNS_SETTINGS_RESP_V01, TYPE16(0, 98), 7},
  {QMI_WDS_GET_PRE_DORMANCY_CDMA_SETTINGS_RESP_V01, TYPE16(0, 100), 13},
  {QMI_WDS_SET_CAM_TIMER_RESP_V01, TYPE16(0, 102), 7},
  {QMI_WDS_GET_CAM_TIMER_RESP_V01, TYPE16(0, 104), 14},
  {QMI_WDS_SET_SCRM_RESP_V01, TYPE16(0, 106), 7},
  {QMI_WDS_GET_SCRM_RESP_V01, TYPE16(0, 108), 11},
  {QMI_WDS_SET_RDUD_RESP_V01, TYPE16(0, 110), 7},
  {QMI_WDS_GET_RDUD_RESP_V01, TYPE16(0, 112), 11},
  {QMI_WDS_GET_SIP_MIP_CALL_TYPE_RESP_V01, TYPE16(0, 114), 11},
  {QMI_WDS_SET_EVDO_PAGE_MONITOR_PERIOD_RESP_V01, TYPE16(0, 116), 7},
  {QMI_WDS_SET_EVDO_FORCE_LONG_SLEEP_RESP_V01, TYPE16(0, 119), 7},
  {QMI_WDS_GET_EVDO_PAGE_MONITOR_PERIOD_RESP_V01, TYPE16(0, 121), 12},
  {QMI_WDS_GET_CALL_THROTTLE_INFO_RESP_V01, TYPE16(0, 123), 18},
  {QMI_WDS_GET_NAAPI_RESP_V01, TYPE16(0, 125), 19},
  {QMI_WDS_SET_DUN_CTRL_PREF_RESP_V01, TYPE16(0, 127), 7},
  {QMI_WDS_GET_DUN_CTRL_INFO_RESP_V01, TYPE16(0, 129), 23},
  {QMI_WDS_SET_DUN_CTRL_EVENT_REPORT_RESP_V01, TYPE16(0, 131), 11},
  {QMI_WDS_CONTROL_PENDING_DUN_CALL_RESP_V01, TYPE16(0, 134), 7},
  {QMI_WDS_EMBMS_TMGI_ACTIVATE_RESP_V01, TYPE16(0, 136), 12},
  {QMI_WDS_EMBMS_TMGI_DEACTIVATE_RESP_V01, TYPE16(0, 139), 12},
  {QMI_WDS_EMBMS_TMGI_LIST_QUERY_RESP_V01, TYPE16(0, 142), 1043},
  {QMI_WDS_GET_PREFERRED_DATA_SYSTEM_RESP_V01, TYPE16(0, 145), 14},
  {QMI_WDS_GET_LAST_DATA_CALL_STATUS_RESP_V01, TYPE16(0, 147), 16},
  {QMI_WDS_GET_CURRENT_SYSTEM_STATUS_RESP_V01, TYPE16(0, 149), 156},
  {QMI_WDS_GET_PDN_THROTTLE_INFO_RESP_V01, TYPE16(0, 151), 1299},
  {QMI_WDS_GET_LTE_ATTACH_PARAMS_RESP_V01, TYPE16(0, 153), 168},
  {QMI_WDS_RESET_PKT_STATISTICS_RESP_V01, TYPE16(0, 155), 7},
  {QMI_WDS_GET_FLOW_CONTROL_STATUS_RESP_V01, TYPE16(0, 157), 11}
};

static const qmi_idl_service_message_table_entry wds_service_indication_messages_v01[] = {
  {QMI_WDS_EVENT_REPORT_IND_V01, TYPE16(0, 4), 287},
  {QMI_WDS_PKT_SRVC_STATUS_IND_V01, TYPE16(0, 15), 26},
  {QMI_WDS_DUN_CALL_INFO_IND_V01, TYPE16(0, 52), 50},
  {QMI_WDS_EVDO_PAGE_MONITOR_PERIOD_RESULT_IND_V01, TYPE16(0, 117), 4},
  {QMI_WDS_DUN_CTRL_EVENT_REPORT_IND_V01, TYPE16(0, 132), 19},
  {QMI_WDS_EMBMS_TMGI_ACTIVATE_IND_V01, TYPE16(0, 137), 18},
  {QMI_WDS_EMBMS_TMGI_DEACTIVATE_IND_V01, TYPE16(0, 140), 18},
  {QMI_WDS_EMBMS_TMGI_LIST_IND_V01, TYPE16(0, 143), 1036}
};
