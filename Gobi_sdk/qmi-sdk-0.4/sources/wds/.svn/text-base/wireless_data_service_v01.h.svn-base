...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 QUALCOMM Proprietary and Confidential.
  ...
  $Header: //source/qcom/qct/interfaces/qmi/wds/main/latest/api/wireless_data_service_v01.h#20 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define WDS_V01_IDL_MINOR_VERS 0x1B
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define WDS_V01_IDL_TOOL_VERS 0x05
/** Maximum Defined Message ID */
#define WDS_V01_MAX_MESSAGE_ID 0x0087;
/** 
    @} 
  */
...
typedef struct {
  ...
  /**<   IP Family Preference. If this TLV is absent, the device attempts to bring up a call
...
typedef struct {
  ...
  /**<   PCSCF IPv6 server address (in network byte order); 
       this is an 8-element array of 16-bit numbers, each
       of which is in big endian format.
   */
...
typedef struct {
  ...
  /**<   Values: \n
       ...
       Note: if inactive, this TLV is not be included in the response and
       the device defaults to use 0x00. Autoconnect is always allowed.
...
typedef struct {
  ...
  /**<   Peroid between transfer statistic reports. Values: \n
       - 0 -- Do not report \n
       - Other -- Peroid between reports (seconds)
   */
...
typedef struct {
  ...
  wds_embms_extended_error_code_enum_v01 extended_error_code;
  /**<   Values: \n
       - 108 -- Not supported; the control point did not activate the TMGI \n
       - 124 -- Invalid; the TMGI did not activate \n
       - 203 -- Deactivation is in progress
   */
