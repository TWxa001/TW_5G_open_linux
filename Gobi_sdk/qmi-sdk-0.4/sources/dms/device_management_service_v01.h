...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/dms/main/latest/api/device_management_service_v01.h#18 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
extern "C" {
#endif
#define QMI_DMS_NV_LEN_V01 2048
...
#define DMS_V01_IDL_MINOR_VERS 0x13
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define DMS_V01_IDL_TOOL_VERS 0x05
/** Maximum Defined Message ID */
#define DMS_V01_MAX_MESSAGE_ID 0x0055

#define DMS_LCT_VAL_BASE_VALUE  0x1000
/** 
    @} 
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Bitmask of simultaneous voice and data support available on the device. Values: \n
       ...
       Note: Zero bits set means that neither of the defined capabilities are supported.
  */
...
typedef struct {
  ...
  /* Optional */
  /*  SN */
  uint8_t sn_valid;  /**< Must be set to true if imei is being passed */
  char sn[QMI_DMS_SN_MAX_V01 + 1];
  /**<   String containing the SN
      (SN) of the device.
   */
...
/********************************************************************
 *LCT ADD FOR SELF DEFINED QMI COMMANDS STRUCTURE DEFINATION
 *qiaoyongkang add 2014.04.02
 * ******************************************************************/
/*
 * dms_get_lctsw_version_req_msg is empty
 * typedef struct {
 * }dms_get_sw_version_req_msg_v01;
 */
...
typedef struct {
  ...
  /* Mandatory */
  /*  Software Version Information */
 // char sw_version[QMI_DMS_FACTORY_SN_MAX_V01 ];
  /**<   String representing the software version information.
   */
  uint8_t sw_valid;  /**< Must be set to true if nv value is being passed */
  uint32_t sw_len;
  char sw_version[128];
}dms_get_lctsw_version_resp_msg_v01;  /* Message */
/** @addtogroup dms_qmi_messages
    @{
  */
/** Request Message; Get nv value.*/
typedef struct {

  /* Mandatory */
  /*  NV id */
  uint16_t nv_id;
}dms_get_nv_req_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  /* Optional */
  /*  NV value */
  uint8_t nv_valid;  /**< Must be set to true if nv value is being passed */
  uint32_t nv_len;
  char nv[QMI_DMS_NV_LEN_V01];
}dms_get_nv_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint32_t nv_len;
  char nv[QMI_DMS_NV_LEN_V01];
}dms_put_nv_req_msg_v01;  /* Message */
...
}dms_set_roam_req_msg_v01;

typedef struct {
	
  qmi_response_type_v01 resp;  

}dms_set_roam_resp_msg_v01;

typedef struct {
	
       uint8_t  apn_flag;

}dms_set_apn_flag_req_msg_v01;

typedef struct {
	
  qmi_response_type_v01 resp;    

}dms_set_apn_flag_resp_msg_v01;
...
/** @addtogroup dms_qmi_messages
    @{
  */
/** Response Message; Put nv value.*/
typedef struct {

  /* Mandatory */
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_put_nv_resp_msg_v01;  /* Message */


typedef struct {
	uint8_t  dtmf_code;
}dms_set_dtmf_tone_req_msg_v01;
...
typedef struct {
  ...
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_set_dtmf_tone_resp_msg_v01;  /* Message */

/** @addtogroup dms_qmi_enums
    @{
  */
typedef enum {
  DMS_DTMF_CODE_ENUM_MIN_ENUM_VAL_V01 = 0, /**< To force a 8 bit unsigned enum.  Do not change or use*/
  DMS_DTMF_CODE_INVALIDATE_V01 = 0x00, 
  DMS_DTMF_CODE_NUM_1_V01 = 0x01,       // 1 
  DMS_DTMF_CODE_NUM_2_V01 = 0x02,       // 2 
  DMS_DTMF_CODE_NUM_3_V01 = 0x03,       // 3 
  DMS_DTMF_CODE_NUM_4_V01 = 0x04,       // 4 
  DMS_DTMF_CODE_NUM_5_V01 = 0x05,       // 5 
  DMS_DTMF_CODE_NUM_6_V01 = 0x06,       // 6 
  DMS_DTMF_CODE_NUM_7_V01 = 0x07,       // 7 
  DMS_DTMF_CODE_NUM_8_V01 = 0x08,       // 8
  DMS_DTMF_CODE_NUM_9_V01 = 0x09,       // 9
  DMS_DTMF_CODE_NUM_STAR_V01 = 0x0a,    // *
  DMS_DTMF_CODE_NUM_0_V01 = 0x0b,       // 0
  DMS_DTMF_CODE_NUM_SHARP_V01 = 0x0c,   // #
  DMS_DTMF_CODE_ENUM_MAX_ENUM_VAL_V01 = 255 /**< To force a 8 bit unsigned enum.  Do not change or use*/
}dms_dtmf_code_enum_v01;
/**
    @}
  */
typedef struct {
	uint8_t  dtmf_code;
}dms_dtmf_tone_indication_msg_v01;
...
/********************************************************************
 *LCT ADD FOR SELF DEFINATION QMI COMMANDS
 *qiaoyongkang add 2014.04.02
 * ******************************************************************/
#define QMI_DMS_GET_NV_REQ_V01              (DMS_LCT_VAL_BASE_VALUE+1)
#define QMI_DMS_GET_NV_RESP_V01             (DMS_LCT_VAL_BASE_VALUE+1)
#define QMI_DMS_PUT_NV_REQ_V01              (DMS_LCT_VAL_BASE_VALUE+2)
#define QMI_DMS_PUT_NV_RESP_V01             (DMS_LCT_VAL_BASE_VALUE+2)
#define QMI_DMS_SET_ROAM_REQ_V01            (DMS_LCT_VAL_BASE_VALUE+3)
#define QMI_DMS_SET_ROAM_RESP_V01           (DMS_LCT_VAL_BASE_VALUE+3)
#define QMI_DMS_SET_APN_FLAG_REQ_REQ_V01    (DMS_LCT_VAL_BASE_VALUE+4)
#define QMI_DMS_SET_APN_FLAG_REQ_RESP_V01   (DMS_LCT_VAL_BASE_VALUE+4)
#define QMI_DMS_GET_SN_REQ_REQ_V01          (DMS_LCT_VAL_BASE_VALUE+5)
#define QMI_DMS_GET_SN_REQ_RESP_V01         (DMS_LCT_VAL_BASE_VALUE+5)

#define QMI_DMS_GET_LCTSW_VERSION_REQ_V01   (DMS_LCT_VAL_BASE_VALUE+6)
#define QMI_DMS_GET_LCTSW_VERSION_RESP_V01  (DMS_LCT_VAL_BASE_VALUE+6)

#define QMI_DMS_SET_DTMF_TONE_REQ_V01   (DMS_LCT_VAL_BASE_VALUE+8)
#define QMI_DMS_SET_DTMF_TONE_RESP_V01  (DMS_LCT_VAL_BASE_VALUE+8)
#define QMI_DMS_DTMF_TONE_IND_V01       (DMS_LCT_VAL_BASE_VALUE+8)
/**
    @}
  */
