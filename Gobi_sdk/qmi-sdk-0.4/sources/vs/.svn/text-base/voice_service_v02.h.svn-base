...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/voice/main/latest/api/voice_service_v02.h#21 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define VOICE_V02_IDL_MINOR_VERS 0x14
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define VOICE_V02_IDL_TOOL_VERS 0x05
/** Maximum Defined Message ID */
#define VOICE_V02_MAX_MESSAGE_ID 0x0059;
/** 
    @} 
  */
...
typedef enum {
  ...
  CALL_TYPE_VOICE_V02 = 0x00, 
  CALL_TYPE_VOICE_FORCED_V02 = 0x01, 
  CALL_TYPE_VOICE_IP_V02 = 0x02, 
  CALL_TYPE_VT_V02 = 0x03, 
  CALL_TYPE_VIDEOSHARE_V02 = 0x04, 
  CALL_TYPE_TEST_V02 = 0x05, 
  CALL_TYPE_OTAPA_V02 = 0x06, 
  CALL_TYPE_STD_OTASP_V02 = 0x07, 
  CALL_TYPE_NON_STD_OTASP_V02 = 0x08, 
  CALL_TYPE_EMERGENCY_V02 = 0x09, 
  CALL_TYPE_SUPS_V02 = 0x0A, 
  CALL_TYPE_EMERGENCY_IP_V02 = 0x0B, 
...
#define VOICE_CALL_ATTRIB_TX_V02 ((voice_call_attribute_type_mask_v02)0x01ull) 
#define VOICE_CALL_ATTRIB_RX_V02 ((voice_call_attribute_type_mask_v02)0x02ull) 
/** @addtogroup voice_qmi_enums
    @{
  */
typedef enum {
...
typedef struct {
  ...
  */
  ...
  /**<   Call type. Values: \n
       ...
       - 0x04 -- CALL_TYPE_VIDEOSHARE    -- Video Share call \n
  ...
  */
  ...
  /* Optional */
  /*  Call Attributes for a Videoshare Call */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  /*  File Attributes for a Videoshare Call */
...
typedef enum {
  ...
  CALL_DIRECTION_MO_V02 = 0x01, 
  CALL_DIRECTION_MT_V02 = 0x02, 
...
typedef enum {
  ...
  CALL_MODE_NO_SRV_V02 = 0x00, 
  CALL_MODE_CDMA_V02 = 0x01, 
  CALL_MODE_GSM_V02 = 0x02, 
  CALL_MODE_UMTS_V02 = 0x03, 
  CALL_MODE_LTE_V02 = 0x04, 
  CALL_MODE_TDS_V02 = 0x05, 
  CALL_MODE_UNKNOWN_V02 = 0x06, 
...
typedef struct {
  ...
  */
  ...
  /**<   Call type. Values: \n
       ...
       - 0x08 -- CALL_TYPE_NON_STD_OTASP -- Nonstandard OTASP \n
       - 0x09 -- CALL_TYPE_EMERGENCY     -- Emergency \n       
       - 0x0B -- CALL_TYPE_EMERGENCY_IP  -- Emergency VOIP call
  */
...
typedef struct {
  ...
  */
  ...
  /**<   Reason. Values: \n
       ...
       - 0x0F -- QMI_VOICE_REASON_CALLWAITING -- Call waiting
  */
...
typedef enum {
  ...
  TTY_MODE_FULL_V02 = 0x00, 
  TTY_MODE_VCO_V02 = 0x01, 
  TTY_MODE_HCO_V02 = 0x02, 
  TTY_MODE_OFF_V02 = 0x03, 
