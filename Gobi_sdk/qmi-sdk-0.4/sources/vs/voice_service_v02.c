...
GENERAL DESCRIPTION
  ...
  $Header: //source/qcom/qct/interfaces/qmi/voice/main/latest/src/voice_service_v02.c#21 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 5.6 
   It was generated on: Tue Nov 27 2012
...
static const uint8_t voice_indication_register_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, page_miss_events) - QMI_IDL_OFFSET8(voice_indication_register_req_msg_v02, page_miss_events_valid)),
  0x1D,
  QMI_IDL_GENERIC_1_BYTE,
...
static const uint8_t voice_dial_call_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, videoshare_call_attribs) - QMI_IDL_OFFSET16RELATIVE(voice_dial_call_req_msg_v02, videoshare_call_attribs_valid)),
  0x1B,
  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
...
static const uint8_t voice_answer_call_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_answer_call_req_msg_v02, file_attributes) - QMI_IDL_OFFSET8(voice_answer_call_req_msg_v02, file_attributes_valid)),
  0x14,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_SZ_IS_16 |   QMI_IDL_STRING,
...
static const uint8_t voice_get_call_info_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, video_attrib) - QMI_IDL_OFFSET16RELATIVE(voice_get_call_info_resp_msg_v02, video_attrib_valid)),
  0x1D,
  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_GENERIC_8_BYTE,
...
static const uint8_t voice_all_call_status_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, vs_variant) - QMI_IDL_OFFSET16RELATIVE(voice_all_call_status_ind_msg_v02, vs_variant_valid)),
  0x1D,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
...
static const uint8_t voice_get_all_call_info_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, video_attrib) - QMI_IDL_OFFSET16RELATIVE(voice_get_all_call_info_resp_msg_v02, video_attrib_valid)),
  0x20,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
...
static const uint8_t voice_manage_calls_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_manage_calls_req_msg_v02, call_id) - QMI_IDL_OFFSET8(voice_manage_calls_req_msg_v02, call_id_valid)),
  0x10,
  QMI_IDL_GENERIC_1_BYTE,
...
static const uint8_t voice_sups_notification_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_sups_notification_ind_msg_v02, ect_number) - QMI_IDL_OFFSET8(voice_sups_notification_ind_msg_v02, ect_number_valid)),
  0x11,
  QMI_IDL_AGGREGATE,
...
static const uint8_t voice_set_sups_service_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET16RELATIVE(voice_set_sups_service_resp_msg_v02, service_status) - QMI_IDL_OFFSET16RELATIVE(voice_set_sups_service_resp_msg_v02, service_status_valid)),
  0x15,
  QMI_IDL_FLAGS_OFFSET_IS_16 | QMI_IDL_AGGREGATE,
...
static const uint8_t voice_manage_ip_calls_req_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_manage_ip_calls_req_msg_v02, sip_uri) - QMI_IDL_OFFSET8(voice_manage_ip_calls_req_msg_v02, sip_uri_valid)),
  0x14,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_STRING,
...
static const uint8_t voice_modified_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, video_attrib) - QMI_IDL_OFFSET8(voice_modified_ind_msg_v02, video_attrib_valid)),
  0x12,
  QMI_IDL_GENERIC_8_BYTE,
...
static const uint8_t voice_speech_codec_info_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(voice_speech_codec_info_ind_msg_v02, speech_enc_samp_freq) - QMI_IDL_OFFSET8(voice_speech_codec_info_ind_msg_v02, speech_enc_samp_freq_valid)),
  0x12,
  QMI_IDL_GENERIC_4_BYTE,
...
{&voice_qmi_idl_type_table_object_v02, &common_qmi_idl_type_table_object_v01};
...
static const qmi_idl_service_message_table_entry voice_service_command_messages_v02[] = {
  {QMI_VOICE_INDICATION_REGISTER_REQ_V02, TYPE16(0, 0), 56},
  {QMI_VOICE_DIAL_CALL_REQ_V02, TYPE16(0, 2), 860},
  {QMI_VOICE_END_CALL_REQ_V02, TYPE16(0, 4), 4},
  {QMI_VOICE_ANSWER_CALL_REQ_V02, TYPE16(0, 6), 540},
  {QMI_VOICE_GET_CALL_INFO_REQ_V02, TYPE16(0, 8), 4},
  {QMI_VOICE_SEND_FLASH_REQ_V02, TYPE16(0, 12), 92},
  {QMI_VOICE_BURST_DTMF_REQ_V02, TYPE16(0, 14), 42},
  {QMI_VOICE_START_CONT_DTMF_REQ_V02, TYPE16(0, 16), 5},
  {QMI_VOICE_STOP_CONT_DTMF_REQ_V02, TYPE16(0, 18), 4},
  {QMI_VOICE_SET_PREFERRED_PRIVACY_REQ_V02, TYPE16(0, 21), 4},
  {QMI_VOICE_GET_ALL_CALL_INFO_REQ_V02, TYPE16(0, 25), 0},
  {QMI_VOICE_MANAGE_CALLS_REQ_V02, TYPE16(0, 27), 8},
  {QMI_VOICE_SET_SUPS_SERVICE_REQ_V02, TYPE16(0, 30), 116},
  {QMI_VOICE_GET_CALL_WAITING_REQ_V02, TYPE16(0, 32), 11},
  {QMI_VOICE_GET_CALL_BARRING_REQ_V02, TYPE16(0, 34), 15},
  {QMI_VOICE_GET_CLIP_REQ_V02, TYPE16(0, 36), 0},
  {QMI_VOICE_GET_CLIR_REQ_V02, TYPE16(0, 38), 0},
  {QMI_VOICE_GET_CALL_FORWARDING_REQ_V02, TYPE16(0, 40), 15},
  {QMI_VOICE_SET_CALL_BARRING_PASSWORD_REQ_V02, TYPE16(0, 42), 16},
  {QMI_VOICE_ORIG_USSD_REQ_V02, TYPE16(0, 44), 187},
  {QMI_VOICE_ANSWER_USSD_REQ_V02, TYPE16(0, 46), 187},
  {QMI_VOICE_CANCEL_USSD_REQ_V02, TYPE16(0, 48), 0},
  {QMI_VOICE_SET_CONFIG_REQ_V02, TYPE16(0, 53), 39},
  {QMI_VOICE_GET_CONFIG_REQ_V02, TYPE16(0, 55), 36},
  {QMI_VOICE_ORIG_USSD_NO_WAIT_REQ_V02, TYPE16(0, 58), 187},
  {QMI_VOICE_BIND_SUBSCRIPTION_REQ_V02, TYPE16(0, 61), 4},
  {QMI_VOICE_ALS_SET_LINE_SWITCHING_REQ_V02, TYPE16(0, 63), 4},
  {QMI_VOICE_ALS_SELECT_LINE_REQ_V02, TYPE16(0, 65), 4},
  {QMI_VOICE_AOC_RESET_ACM_REQ_V02, TYPE16(0, 67), 0},
  {QMI_VOICE_AOC_SET_ACMMAX_REQ_V02, TYPE16(0, 69), 7},
  {QMI_VOICE_AOC_GET_CALL_METER_INFO_REQ_V02, TYPE16(0, 71), 5},
  {QMI_VOICE_GET_COLP_REQ_V02, TYPE16(0, 74), 0},
  {QMI_VOICE_GET_COLR_REQ_V02, TYPE16(0, 76), 0},
  {QMI_VOICE_GET_CNAP_REQ_V02, TYPE16(0, 78), 0},
  {QMI_VOICE_MANAGE_IP_CALLS_REQ_V02, TYPE16(0, 80), 165},
  {QMI_VOICE_ALS_GET_LINE_SWITCHING_STATUS_REQ_V02, TYPE16(0, 82), 0},
  {QMI_VOICE_ALS_GET_SELECTED_LINE_REQ_V02, TYPE16(0, 84), 0}
};

static const qmi_idl_service_message_table_entry voice_service_response_messages_v02[] = {
  {QMI_VOICE_INDICATION_REGISTER_RESP_V02, TYPE16(0, 1), 7},
  {QMI_VOICE_DIAL_CALL_RESP_V02, TYPE16(0, 3), 212},
  {QMI_VOICE_END_CALL_RESP_V02, TYPE16(0, 5), 11},
  {QMI_VOICE_ANSWER_CALL_RESP_V02, TYPE16(0, 7), 11},
  {QMI_VOICE_GET_CALL_INFO_RESP_V02, TYPE16(0, 9), 776},
  {QMI_VOICE_SEND_FLASH_RESP_V02, TYPE16(0, 13), 11},
  {QMI_VOICE_BURST_DTMF_RESP_V02, TYPE16(0, 15), 11},
  {QMI_VOICE_START_CONT_DTMF_RESP_V02, TYPE16(0, 17), 11},
  {QMI_VOICE_STOP_CONT_DTMF_RESP_V02, TYPE16(0, 19), 11},
  {QMI_VOICE_SET_PREFERRED_PRIVACY_RESP_V02, TYPE16(0, 22), 7},
  {QMI_VOICE_GET_ALL_CALL_INFO_RESP_V02, TYPE16(0, 26), 6378},
  {QMI_VOICE_MANAGE_CALLS_RESP_V02, TYPE16(0, 28), 12},
  {QMI_VOICE_SET_SUPS_SERVICE_RSEP_V02, TYPE16(0, 31), 217},
  {QMI_VOICE_GET_CALL_WAITING_RESP_V02, TYPE16(0, 33), 223},
  {QMI_VOICE_GET_CALL_BARRING_RESP_V02, TYPE16(0, 35), 223},
  {QMI_VOICE_GET_CLIP_RESP_V02, TYPE16(0, 37), 217},
  {QMI_VOICE_GET_CLIR_RESP_V02, TYPE16(0, 39), 217},
  {QMI_VOICE_GET_CALL_FORWARDING_RESP_V02, TYPE16(0, 41), 3682},
  {QMI_VOICE_SET_CALL_BARRING_PASSWORD_RESP_V02, TYPE16(0, 43), 212},
  {QMI_VOICE_ORIG_USSD_RESP_V02, TYPE16(0, 45), 767},
  {QMI_VOICE_ANSWER_USSD_RESP_V02, TYPE16(0, 47), 7},
  {QMI_VOICE_CANCEL_USSD_RESP_V02, TYPE16(0, 49), 7},
  {QMI_VOICE_SET_CONFIG_RESP_V02, TYPE16(0, 54), 31},
  {QMI_VOICE_GET_CONFIG_RESP_V02, TYPE16(0, 56), 55},
  {QMI_VOICE_ORIG_USSD_NO_WAIT_RESP_V02, TYPE16(0, 59), 7},
  {QMI_VOICE_BIND_SUBSCRIPTION_RESP_V02, TYPE16(0, 62), 7},
  {QMI_VOICE_ALS_SET_LINE_SWITCHING_RESP_V02, TYPE16(0, 64), 7},
  {QMI_VOICE_ALS_SELECT_LINE_RESP_V02, TYPE16(0, 66), 7},
  {QMI_VOICE_AOC_RESET_ACM_RESP_V02, TYPE16(0, 68), 7},
  {QMI_VOICE_AOC_SET_ACMMAX_RESP_V02, TYPE16(0, 70), 7},
  {QMI_VOICE_AOC_GET_CALL_METER_INFO_RESP_V02, TYPE16(0, 72), 28},
  {QMI_VOICE_GET_COLP_RESP_V02, TYPE16(0, 75), 217},
  {QMI_VOICE_GET_COLR_RESP_V02, TYPE16(0, 77), 217},
  {QMI_VOICE_GET_CNAP_RESP_V02, TYPE16(0, 79), 217},
  {QMI_VOICE_MANAGE_IP_CALLS_RESP_V02, TYPE16(0, 81), 20},
  {QMI_VOICE_ALS_GET_LINE_SWITCHING_STATUS_RESP_V02, TYPE16(0, 83), 11},
  {QMI_VOICE_ALS_GET_SELECTED_LINE_RESP_V02, TYPE16(0, 85), 11}
};

static const qmi_idl_service_message_table_entry voice_service_indication_messages_v02[] = {
  {QMI_VOICE_OTASP_STATUS_IND_V02, TYPE16(0, 10), 5},
  {QMI_VOICE_INFO_REC_IND_V02, TYPE16(0, 11), 1101},
  {QMI_VOICE_DTMF_IND_V02, TYPE16(0, 20), 78},
  {QMI_VOICE_PRIVACY_IND_V02, TYPE16(0, 23), 5},
  {QMI_VOICE_ALL_CALL_STATUS_IND_V02, TYPE16(0, 24), 5474},
  {QMI_VOICE_SUPS_NOTIFICATION_IND_V02, TYPE16(0, 29), 97},
  {QMI_VOICE_USSD_RELEASE_IND_V02, TYPE16(0, 50), 0},
  {QMI_VOICE_USSD_IND_V02, TYPE16(0, 51), 559},
  {QMI_VOICE_UUS_IND_V02, TYPE16(0, 52), 135},
  {QMI_VOICE_SUPS_IND_V02, TYPE16(0, 57), 2015},
  {QMI_VOICE_ORIG_USSD_NO_WAIT_IND_V02, TYPE16(0, 60), 752},
  {QMI_VOICE_AOC_LOW_FUNDS_IND_V02, TYPE16(0, 73), 0},
  {QMI_VOICE_MODIFIED_IND_V02, TYPE16(0, 86), 30},
  {QMI_VOICE_MODIFY_ACCEPT_IND_V02, TYPE16(0, 87), 30},
  {QMI_VOICE_SPEECH_CODEC_INFO_IND_V02, TYPE16(0, 88), 21},
  {QMI_VOICE_HANDOVER_IND_V02, TYPE16(0, 89), 7},
  {QMI_VOICE_CONFERENCE_INFO_IND_V02, TYPE16(0, 90), 2067},
  {QMI_VOICE_CONFERENCE_JOIN_IND_V02, TYPE16(0, 91), 393},
  {QMI_VOICE_CONFERENCE_PARTICIPANT_UPDATE_IND_V02, TYPE16(0, 92), 389},
  {QMI_VOICE_EXT_BRST_INTL_IND_V02, TYPE16(0, 93), 9},
  {QMI_VOICE_MT_PAGE_MISS_IND_V02, TYPE16(0, 94), 5}
};
