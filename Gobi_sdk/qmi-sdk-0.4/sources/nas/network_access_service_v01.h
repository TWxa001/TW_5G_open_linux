...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //source/qcom/qct/interfaces/qmi/nas/main/latest/api/network_access_service_v01.h#45 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define NAS_V01_IDL_MINOR_VERS 0x31
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define NAS_V01_IDL_TOOL_VERS 0x05
/** Maximum Defined Message ID */
#define NAS_V01_MAX_MESSAGE_ID 0x0071;
/** 
    @} 
  */
...
typedef struct {
  ...
  /**<   Bitmask representing the network type to scan. Values: \n
       ...
       - Bit 2 -- LTE \n
       - Bit 3 -- TD-SCDMA \n
       Any combination of the bit positions can be used.
    */
...
typedef enum {
  ...
  NAS_CELL_ACCESS_UNKNOWN_V01 = -1, /**<  Cell access type unknown   */
...
#define NAS_TDSCDMA_BAND_A_V01 ((nas_tdscdma_band_pref_mask_type_v01)0x01ull) 
#define NAS_TDSCDMA_BAND_B_V01 ((nas_tdscdma_band_pref_mask_type_v01)0x02ull) 
#define NAS_TDSCDMA_BAND_C_V01 ((nas_tdscdma_band_pref_mask_type_v01)0x04ull) 
#define NAS_TDSCDMA_BAND_D_V01 ((nas_tdscdma_band_pref_mask_type_v01)0x08ull) 
#define NAS_TDSCDMA_BAND_E_V01 ((nas_tdscdma_band_pref_mask_type_v01)0x10ull) 
#define NAS_TDSCDMA_BAND_F_V01 ((nas_tdscdma_band_pref_mask_type_v01)0x20ull) 
/** @addtogroup nas_qmi_aggregates
    @{
  */
typedef struct {
...
typedef struct {
  ...
  */
  ...
  /**<   Received signal code power; the received power on one code measured in 
       dBm on the primary CPICH channel of neighbor/monitored cell.
  */
...
typedef struct {
  ...
  */
  ...
  int16_t rscp;
  /**<   Received signal code power; the received power on one code measured in
       dBm on the primary CPICH channel of serving cell.
  */

  /*  Ec/Io */
  int16_t ecio;
  /**<   ECIO; the received energy per chip divided by the power density in the
       band measured in dBm on the primary CPICH channel of serving cell.
  */
