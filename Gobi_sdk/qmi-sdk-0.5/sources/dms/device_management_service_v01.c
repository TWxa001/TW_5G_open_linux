...
GENERAL DESCRIPTION
  ...
  $Header: //source/qcom/qct/interfaces/qmi/dms/main/latest/src/device_management_service_v01.c#18 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 5.6 
   It was generated on: Thu Jan 24 2013
...
static const uint8_t dms_set_event_report_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_set_event_report_req_msg_v01, report_prl_init) - QMI_IDL_OFFSET8(dms_set_event_report_req_msg_v01, report_prl_init_valid)),
  0x17,
  QMI_IDL_GENERIC_1_BYTE,
...
static const uint8_t dms_event_report_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_event_report_ind_msg_v01, prl_init) - QMI_IDL_OFFSET8(dms_event_report_ind_msg_v01, prl_init_valid)),
  0x17,
  QMI_IDL_1_BYTE_ENUM,
...
static const uint8_t dms_get_device_cap_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_device_cap_resp_msg_v01, simul_voice_and_data_capability) - QMI_IDL_OFFSET8(dms_get_device_cap_resp_msg_v01, simul_voice_and_data_capability_valid)),
  0x12,
  QMI_IDL_GENERIC_8_BYTE,
...
/* 
 * dms_get_sn_req_msg is empty
 * static const uint8_t dms_get_sn_req_msg_data_v01[] = {
 * };
 */
...
static const uint8_t dms_get_sn_resp_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_sn_resp_msg_v01, sn) - QMI_IDL_OFFSET8(dms_get_sn_resp_msg_v01, sn_valid)),
  0x14,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |   QMI_IDL_STRING,
  QMI_IDL_OFFSET8(dms_get_sn_resp_msg_v01, sn),
  QMI_DMS_SN_MAX_V01
};
...
static const uint8_t dms_get_lctsw_version_resp_msg_data_v01[] = {
  0x02,
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dms_get_lctsw_version_resp_msg_v01, resp),
  0,1,
  
//  0x15,
//  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_STRING,
//  QMI_IDL_OFFSET8(dms_get_lctsw_version_resp_msg_v01, sw_version),
//  QMI_DMS_FACTORY_SN_MAX_V01  //128
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_lctsw_version_resp_msg_v01, sw_version) - QMI_IDL_OFFSET8(dms_get_lctsw_version_resp_msg_v01, sw_valid)),
  0x15,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_GENERIC_1_BYTE | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_FIRST_EXTENDED,
  QMI_IDL_FLAGS_ARRAY_DATA_ONLY | QMI_IDL_FLAGS_ARRAY_IS_LENGTHLESS,
  QMI_IDL_OFFSET8(dms_get_lctsw_version_resp_msg_v01, sw_version),
  ((128) & 0xFF), ((128) >> 8),
  QMI_IDL_OFFSET8(dms_get_lctsw_version_resp_msg_v01, sw_version) - QMI_IDL_OFFSET8(dms_get_lctsw_version_resp_msg_v01, sw_len)
};
...
static const uint8_t dms_get_nv_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(dms_get_nv_req_msg_v01, nv_id)
};

static const uint8_t dms_get_nv_resp_msg_data_v01[] = {
  0x02,
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dms_get_nv_resp_msg_v01, resp),
  0, 1,

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(dms_get_nv_resp_msg_v01, nv) - QMI_IDL_OFFSET8(dms_get_nv_resp_msg_v01, nv_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_GENERIC_1_BYTE | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_FIRST_EXTENDED,
  QMI_IDL_FLAGS_ARRAY_DATA_ONLY | QMI_IDL_FLAGS_ARRAY_IS_LENGTHLESS,
  QMI_IDL_OFFSET8(dms_get_nv_resp_msg_v01, nv),
  ((QMI_DMS_NV_LEN_V01) & 0xFF), ((QMI_DMS_NV_LEN_V01) >> 8),
  QMI_IDL_OFFSET8(dms_get_nv_resp_msg_v01, nv) - QMI_IDL_OFFSET8(dms_get_nv_resp_msg_v01, nv_len)

};

static const uint8_t dms_set_roam_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_set_roam_req_msg_v01, roam_flag)
};

static const uint8_t dms_set_roam_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dms_set_apn_flag_resp_msg_v01, resp),
  0, 1
};

static const uint8_t dms_set_apn_flag_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_set_apn_flag_req_msg_v01, apn_flag)
};

static const uint8_t dms_set_apn_flag_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dms_set_apn_flag_resp_msg_v01, resp),
  0, 1
...
static const uint8_t dms_set_dtmf_tone_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_set_dtmf_tone_req_msg_v01, dtmf_code)
};

static const uint8_t dms_set_dtmf_tone_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dms_set_dtmf_tone_resp_msg_v01, resp),
  0, 1
};

static const uint8_t dms_dtmf_tone_indication_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(dms_dtmf_tone_indication_msg_v01, dtmf_code)
};

static const uint8_t dms_put_nv_req_msg_data_v01[] = {
  0x01,
  QMI_IDL_GENERIC_2_BYTE,
  QMI_IDL_OFFSET8(dms_put_nv_req_msg_v01, nv_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x2,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_GENERIC_1_BYTE | QMI_IDL_FLAGS_SZ_IS_16 | QMI_IDL_FLAGS_IS_VARIABLE_LEN | QMI_IDL_FLAGS_FIRST_EXTENDED,
  QMI_IDL_FLAGS_ARRAY_DATA_ONLY | QMI_IDL_FLAGS_ARRAY_IS_LENGTHLESS,
  QMI_IDL_OFFSET8(dms_put_nv_req_msg_v01, nv),
  ((QMI_DMS_NV_LEN_V01) & 0xFF), ((QMI_DMS_NV_LEN_V01) >> 8),
  QMI_IDL_OFFSET8(dms_put_nv_req_msg_v01, nv) - QMI_IDL_OFFSET8(dms_put_nv_req_msg_v01, nv_len)
};

static const uint8_t dms_put_nv_resp_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
  QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(dms_put_nv_resp_msg_v01, resp),
  0, 1
};
/* Type Table */
...
/***********************************************************************************************
 *
 * longcheer add self defination qmi commands.
 * qiaoyongkang 2014.04.02
 *
 * ********************************************************************************************/
  {sizeof(dms_get_nv_req_msg_v01), dms_get_nv_req_msg_data_v01},
  {sizeof(dms_get_nv_resp_msg_v01), dms_get_nv_resp_msg_data_v01},
  {sizeof(dms_put_nv_req_msg_v01), dms_put_nv_req_msg_data_v01},
  {sizeof(dms_put_nv_resp_msg_v01), dms_put_nv_resp_msg_data_v01},
  {sizeof(dms_set_roam_req_msg_v01), dms_set_roam_req_msg_data_v01},
  {sizeof(dms_set_roam_resp_msg_v01), dms_set_roam_resp_msg_data_v01},
  {sizeof(dms_set_apn_flag_req_msg_v01), dms_set_apn_flag_req_msg_data_v01},
  {sizeof(dms_set_apn_flag_resp_msg_v01), dms_set_apn_flag_resp_msg_data_v01},
  {0, 0},
  {sizeof(dms_get_sn_resp_msg_data_v01), dms_get_sn_resp_msg_data_v01},
  {0, 0},
  {sizeof(dms_get_lctsw_version_resp_msg_v01),dms_get_lctsw_version_resp_msg_data_v01},  
  {sizeof(dms_set_dtmf_tone_req_msg_v01),dms_set_dtmf_tone_req_msg_data_v01},
  {sizeof(dms_set_dtmf_tone_resp_msg_v01),dms_set_dtmf_tone_resp_msg_data_v01},
  {sizeof(dms_dtmf_tone_indication_msg_v01),dms_dtmf_tone_indication_msg_data_v01}
};
...
/***********************************************************************************************
 *
 * longcheer add self defination qmi commands id startup.
 * qiaoyongkang 2014.04.02
 *
 * ********************************************************************************************/  
#define LONGCHEER_SERVICE_ENTRY_ID 93
...
static const qmi_idl_service_message_table_entry dms_service_command_messages_v01[] = {
  ...
  {QMI_DMS_SET_EVENT_REPORT_REQ_V01, TYPE16(0, 2), 33},
  {QMI_DMS_GET_SUPPORTED_MSGS_REQ_V01, TYPE16(1, 0), 0},
  {QMI_DMS_GET_SUPPORTED_FIELDS_REQ_V01, TYPE16(1, 2), 5},
  ...
  {QMI_DMS_UIM_SET_PIN_PROTECTION_REQ_V01, TYPE16(0, 19), 22},
  {QMI_DMS_UIM_VERIFY_PIN_REQ_V01, TYPE16(0, 21), 21},
  {QMI_DMS_UIM_UNBLOCK_PIN_REQ_V01, TYPE16(0, 23), 38},
  {QMI_DMS_UIM_CHANGE_PIN_REQ_V01, TYPE16(0, 25), 38},
  ...
  {QMI_DMS_GET_ACTIVATION_STATE_REQ_V01, TYPE16(0, 39), 0},
  {QMI_DMS_ACTIVATE_AUTOMATIC_REQ_V01, TYPE16(0, 41), 85},
  {QMI_DMS_ACTIVATE_MANUAL_REQ_V01, TYPE16(0, 43), 1627},
  {QMI_DMS_GET_USER_LOCK_STATE_REQ_V01, TYPE16(0, 45), 0},
  {QMI_DMS_SET_USER_LOCK_STATE_REQ_V01, TYPE16(0, 47), 8},
  {QMI_DMS_SET_USER_LOCK_CODE_REQ_V01, TYPE16(0, 49), 11},
  {QMI_DMS_READ_USER_DATA_REQ_V01, TYPE16(0, 51), 0},
  {QMI_DMS_WRITE_USER_DATA_REQ_V01, TYPE16(0, 53), 517},
  {QMI_DMS_READ_ERI_FILE_REQ_V01, TYPE16(0, 55), 0},
  {QMI_DMS_RESTORE_FACTORY_DEFAULTS_REQ_V01, TYPE16(0, 57), 9},
  {QMI_DMS_VALIDATE_SERVICE_PROGRAMMING_CODE_REQ_V01, TYPE16(0, 59), 9},
  {QMI_DMS_UIM_GET_ICCID_REQ_V01, TYPE16(0, 61), 0},
  {QMI_DMS_UIM_GET_CK_STATUS_REQ_V01, TYPE16(0, 63), 4},
  {QMI_DMS_UIM_SET_CK_PROTECTION_REQ_V01, TYPE16(0, 65), 14},
  {QMI_DMS_UIM_UNBLOCK_CK_REQ_V01, TYPE16(0, 67), 13},
  {QMI_DMS_UIM_GET_IMSI_REQ_V01, TYPE16(0, 69), 0},
  {QMI_DMS_UIM_GET_STATE_REQ_V01, TYPE16(0, 71), 0},
  {QMI_DMS_GET_BAND_CAPABILITY_REQ_V01, TYPE16(0, 73), 0},
  {QMI_DMS_GET_FACTORY_SKU_REQ_V01, TYPE16(0, 75), 0},
  {QMI_DMS_SET_TIME_REQ_V01, TYPE16(0, 77), 18},
  {QMI_DMS_GET_ALT_NET_CONFIG_REQ_V01, TYPE16(0, 79), 0},
  {QMI_DMS_SET_ALT_NET_CONFIG_REQ_V01, TYPE16(0, 81), 4},
  {QMI_DMS_GET_SW_VERSION_REQ_V01, TYPE16(0, 83), 0},
  {QMI_DMS_SET_SPC_REQ_V01, TYPE16(0, 85), 18},
  {QMI_DMS_GET_CURRENT_PRL_INFO_REQ_V01, TYPE16(0, 87), 0},
  {QMI_DMS_BIND_SUBSCRIPTION_REQ_V01, TYPE16(0, 89), 7},
  {QMI_DMS_GET_BIND_SUBSCRIPTION_REQ_V01, TYPE16(0, 91), 0},
/***********************************************************************************************
 *
 * longcheer add self defination qmi commands.
 * qiaoyongkang 2014.04.02
 *
 * ********************************************************************************************/  
  {QMI_DMS_GET_NV_REQ_V01, TYPE16(0, (LONGCHEER_SERVICE_ENTRY_ID+0x00)), 5},
  {QMI_DMS_PUT_NV_REQ_V01, TYPE16(0, (LONGCHEER_SERVICE_ENTRY_ID+0x02)), 2056},
  {QMI_DMS_SET_ROAM_REQ_V01, TYPE16(0, (LONGCHEER_SERVICE_ENTRY_ID+0x04)), 4},
  {QMI_DMS_SET_APN_FLAG_REQ_REQ_V01, TYPE16(0, (LONGCHEER_SERVICE_ENTRY_ID+0x06)), 4},
  {QMI_DMS_GET_SN_REQ_REQ_V01, TYPE16(0, (LONGCHEER_SERVICE_ENTRY_ID+0x08)), 0},
  {QMI_DMS_GET_LCTSW_VERSION_REQ_V01, TYPE16(0, (LONGCHEER_SERVICE_ENTRY_ID+0x0a)), 0},
  {QMI_DMS_SET_DTMF_TONE_REQ_V01, TYPE16(0, (LONGCHEER_SERVICE_ENTRY_ID+0x0c)), 4}
};
...
static const qmi_idl_service_message_table_entry dms_service_response_messages_v01[] = {
  ...
  {QMI_DMS_GET_SUPPORTED_MSGS_RESP_V01, TYPE16(1, 1), 8204},
  {QMI_DMS_GET_SUPPORTED_FIELDS_RESP_V01, TYPE16(1, 3), 115},
  {QMI_DMS_GET_DEVICE_CAP_RESP_V01, TYPE16(0, 6), 70},
  {QMI_DMS_GET_DEVICE_MFR_RESP_V01, TYPE16(0, 8), 138},
  {QMI_DMS_GET_DEVICE_MODEL_ID_RESP_V01, TYPE16(0, 10), 266},
  {QMI_DMS_GET_DEVICE_REV_ID_RESP_V01, TYPE16(0, 12), 543},
  {QMI_DMS_GET_MSISDN_RESP_V01, TYPE16(0, 14), 112},
  {QMI_DMS_GET_DEVICE_SERIAL_NUMBERS_RESP_V01, TYPE16(0, 16), 370},
  ...
  {QMI_DMS_GET_OPERATING_MODE_RESP_V01, TYPE16(0, 32), 20},
  {QMI_DMS_SET_OPERATING_MODE_RESP_V01, TYPE16(0, 34), 7},
  {QMI_DMS_GET_TIME_RESP_V01, TYPE16(0, 36), 40},
  {QMI_DMS_GET_PRL_VER_RESP_V01, TYPE16(0, 38), 16},
  {QMI_DMS_GET_ACTIVATION_STATE_RESP_V01, TYPE16(0, 40), 12},
  {QMI_DMS_ACTIVATE_AUTOMATIC_RESP_V01, TYPE16(0, 42), 7},
  {QMI_DMS_ACTIVATE_MANUAL_RESP_V01, TYPE16(0, 44), 7},
  {QMI_DMS_GET_USER_LOCK_STATE_RESP_V01, TYPE16(0, 46), 11},
  {QMI_DMS_SET_USER_LOCK_STATE_RESP_V01, TYPE16(0, 48), 7},
  {QMI_DMS_SET_USER_LOCK_CODE_RESP_V01, TYPE16(0, 50), 7},
  {QMI_DMS_READ_USER_DATA_RESP_V01, TYPE16(0, 52), 524},
  {QMI_DMS_WRITE_USER_DATA_RESP_V01, TYPE16(0, 54), 7},
  {QMI_DMS_READ_ERI_FILE_RESP_V01, TYPE16(0, 56), 1036},
  {QMI_DMS_RESTORE_FACTORY_DEFAULTS_RESP_V01, TYPE16(0, 58), 7},
  {QMI_DMS_VALIDATE_SERVICE_PROGRAMMING_CODE_RESP_V01, TYPE16(0, 60), 7},
  {QMI_DMS_UIM_GET_ICCID_RESP_V01, TYPE16(0, 62), 30},
  {QMI_DMS_UIM_GET_CK_STATUS_RESP_V01, TYPE16(0, 64), 17},
  {QMI_DMS_UIM_SET_CK_PROTECTION_RESP_V01, TYPE16(0, 66), 11},
  {QMI_DMS_UIM_UNBLOCK_CK_RESP_V01, TYPE16(0, 68), 11},
  {QMI_DMS_UIM_GET_IMSI_RESP_V01, TYPE16(0, 70), 42},
  {QMI_DMS_UIM_GET_STATE_RESP_V01, TYPE16(0, 72), 11},
  {QMI_DMS_GET_BAND_CAPABILITY_RESP_V01, TYPE16(0, 74), 40},
  {QMI_DMS_GET_FACTORY_SKU_RESP_V01, TYPE16(0, 76), 138},
  {QMI_DMS_SET_TIME_RESP_V01, TYPE16(0, 78), 7},
  {QMI_DMS_GET_ALT_NET_CONFIG_RESP_V01, TYPE16(0, 80), 11},
  {QMI_DMS_SET_ALT_NET_CONFIG_RESP_V01, TYPE16(0, 82), 7},
  {QMI_DMS_GET_SW_VERSION_RESP_V01, TYPE16(0, 84), 42},
  {QMI_DMS_SET_SPC_RESP_V01, TYPE16(0, 86), 7},
  {QMI_DMS_GET_CURRENT_PRL_INFO_RESP_V01, TYPE16(0, 88), 16},
  {QMI_DMS_BIND_SUBSCRIPTION_RESP_V01, TYPE16(0, 90), 7},
  {QMI_DMS_GET_BIND_SUBSCRIPTION_RESP_V01, TYPE16(0, 92), 14},
/***********************************************************************************************
 *
 * longcheer add self defination qmi commands.
 * qiaoyongkang 2014.04.02
 *
 * ********************************************************************************************/    
  {QMI_DMS_GET_NV_RESP_V01, TYPE16(0, (LONGCHEER_SERVICE_ENTRY_ID+0x01)), 2058},
  {QMI_DMS_PUT_NV_RESP_V01, TYPE16(0, (LONGCHEER_SERVICE_ENTRY_ID+0x03)), 7},
  {QMI_DMS_SET_ROAM_RESP_V01, TYPE16(0, (LONGCHEER_SERVICE_ENTRY_ID+0x05)), 7},
  {QMI_DMS_SET_APN_FLAG_REQ_RESP_V01, TYPE16(0, (LONGCHEER_SERVICE_ENTRY_ID+0x07)), 7},
  {QMI_DMS_GET_SN_REQ_RESP_V01, TYPE16(0, (LONGCHEER_SERVICE_ENTRY_ID+0x09)), 68},
  {QMI_DMS_GET_LCTSW_VERSION_RESP_V01, TYPE16(0, (LONGCHEER_SERVICE_ENTRY_ID+0x0b)), 137},
  {QMI_DMS_SET_DTMF_TONE_RESP_V01, TYPE16(0, (LONGCHEER_SERVICE_ENTRY_ID+0x0d)), 7}
};

static const qmi_idl_service_message_table_entry dms_service_indication_messages_v01[] = {
  {QMI_DMS_EVENT_REPORT_IND_V01, TYPE16(0, 4), 38},
  {QMI_DMS_DTMF_TONE_IND_V01, TYPE16(0, 4), 4},
};
