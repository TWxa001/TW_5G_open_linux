#ifndef UIM_SERVICE_H
#define UIM_SERVICE_H
/**
...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 QUALCOMM Proprietary and Confidential.
  ...
  $Header: //source/qcom/qct/interfaces/qmi/uim/main/latest/api/user_identity_module_v01.h#12 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define UIM_V01_IDL_MINOR_VERS 0x17
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define UIM_V01_IDL_TOOL_VERS 0x05
/** Maximum Defined Message ID */
#define UIM_V01_MAX_MESSAGE_ID 0x0042;
/** 
    @} 
  */
...
typedef struct {
  ...
  /**<   Indicates the session type. Valid values:\n
...
typedef struct {
  ...
  /**<   Read content. The sequence of bytes as read from the card. */
 ...
 * typedef struct {
 * }uim_get_card_status_req_msg_v01;
 */
...
typedef enum {
  ...
  UIM_CARD_ERROR_CODE_UNKNOWN_V01 = 0x00, 
  UIM_CARD_ERROR_CODE_POWER_DOWN_V01 = 0x01, 
  UIM_CARD_ERROR_CODE_POLL_ERROR_V01 = 0x02, 
  UIM_CARD_ERROR_CODE_NO_ATR_RECEIVED_V01 = 0x03, 
  UIM_CARD_ERROR_CODE_VOLT_MISMATCH_V01 = 0x04, 
  UIM_CARD_ERROR_CODE_PARITY_ERROR_V01 = 0x05, 
  UIM_CARD_ERROR_CODE_POSSIBLY_REMOVED_V01 = 0x06, 
  UIM_CARD_ERROR_CODE_SIM_TECHNICAL_PROBLEMS_V01 = 0x07, 
...
typedef struct {
  ...
  /**<   Index of the primary GW provisioning application. The most significant
       ...
       value 0xFFFF identifies when the session does not exist.
   */
...
typedef struct {
  ...
  /**<   Indicates if the reported status of the card on the corresponding slot is valid.
       Valid values:\n
        - 0 -- Status of the card is unknwon (even if reported as absent)\n
...
typedef struct {
  ...
  /**<   Bitmask of the capabilities the client retrieves from the card. 
       Additional bits are reserved for future use and are to be set to 0.\n
         - Bit 0 -- FDN status\n
...
typedef struct {
  ...
  uint8_t fdn_status_valid;  /**< Must be set to true if fdn_status is being passed */
  uint8_t fdn_status;
  /**<   New value for the FDN service. Valid values:\n
        - 0 -- Disables the FDN\n
        - 1 -- Enables the FDN
   */
...
typedef struct {
  ...
  uint16_t offset;
  /**<   Indicates the offset of the current chunk, starting from 0. */
